...
public class MultiOddThread implements Runnable{

    private final String type;

    private final Object lock;

    public MultiOddThread(String type,Object lock){
        this.type=type;
        this.lock=lock;
    }
    ...
    public void run(){
        while (compare()){
            synchronized (lock){
                if(MultiOddEvenSimulator.curr > MultiOddEvenSimulator.limit) break;
